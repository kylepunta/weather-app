...
const renderUI = (function () {
  ...
  //     "image/svg+xml"
  //   ).documentElement;
  //   weatherIcons[i].appendChild(precipitationIcon);
  // }
  ...
  //   container.appendChild(icons.getRainyIcon());
  // }
  // function renderSunnyCloudyIcon(container) {
  //   container.appendChild(icons.getSunnyCloudyIcon());
  // }
